    ...
    const fetchArticle = async () => {
      if (articleId && user) {
        ...
        if (error) {
          ...
          setCategory(data?.categories?.map((c) => c.category.id) || []);
        }
          ...
          <form onSubmit={handleSubmit} className="space-y-10 relative">
            ...
            <div className="flex lg:flex-row flex-col gap-7 items-center">
              ...
              <div>
                ...
                <label
                  ...
                  className="bg-gradient-to-r from-indigo-500 to-red-500 hover:from-red-500 hover:to-indigo-500 transition-all duration-500 text-[15px] text-white font-bold px-6 py-3 rounded-lg cursor-pointer"
                >
                  Lataa Taustakuva
                </label>
              </div>
            ...
            <div className="space-y-4">
              ...
              <textarea
                ...
                className="bg-[#1a202c] border p-4 rounded-lg w-full outline-none min-h-[200px]"
                value={content}
            ...
            <div className="mt-10">
              ...
              >
                {loading ? (
                  articleId ? (
                    <>
                      Päivitetään Blogi Viestiä{" "}
                      <i className="fas fa-spinner fa-spin ms-2" />
                    </>
                  ) : (
                    <>
                      Luodaan Blogi Viestiä{" "}
                      <i className="fas fa-spinner fa-spin ms-2" />
                    </>
                  )
                ) : articleId ? (
                  <>
                    Päivitä Blogi Viesti{" "}
