...
export default function Page() {
    ...
    // -----------------------------
    // LOAD PROFILE — nostettu ulos useEffect:ista jotta onClick toimii
    // -----------------------------
                    ...
                    <form onSubmit={handleSubmit} className="space-y-10">
                        <div className="mb-10 flex justify-between items-center">
                            <div className="flex items-center gap-6">
                                ...
                                <label htmlFor="profile-image" className="bg-gradient-to-r from-indigo-500 to-red-500 hover:from-red-500 hover:to-indigo-500 transition-all duration-500 text-[15px] text-white font-bold px-6 py-3 rounded-lg cursor-pointer">
                                    Vaihda Profiili kuva <i className="fas fa-image ms-2" />
                                </label>
                            </div>

                            {/* ✅ fetchProfile toimii nyt koska se on määritelty komponentin tasolla */}
                            <button type="button" onClick={fetchProfile} className="text-white text-sm px-4 py-2 rounded-lg border border-gray-600 hover:bg-gray-800 transition">
                                <i className="fas fa-rotate-right me-2" /> Päivitä
                            </button>
                        </div>
